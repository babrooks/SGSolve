...
/*! This class contains a copy of the game used by SGSolver, a list of
    ...
    \ingroup src
*/
class SGSolution_PencilSharpening
{
private:
  SGGame game; /*!< The game that was solved. */
  list<SGIteration_PencilSharpening> iterations; /*!< A list of SGIteration objects
...
public:
  ...
  const list<SGIteration_PencilSharpening> & getIterations() const { return iterations; }
