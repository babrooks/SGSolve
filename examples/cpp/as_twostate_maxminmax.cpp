  ...
  try
    {
      ...
      SGSolution_MaxMinMax::save(soln,"./solutions/as_twostate_maxminmax.sln");
      ...
      catch(SGException e)
	{
      ...
      SGSolution_MaxMinMax::save(soln2,"./solutions/as_twostate_maxminmax_endogenous.sln");

      SGSolution_MaxMinMax soln3;
      SGSolution_MaxMinMax::load(soln3,"./solutions/as_twostate_maxminmax_endogenous.sln");
